...
from models.py_utils import kp, AELoss, _neg_loss, convolution, residual
...
if __name__ == '__main__':
    ...
    input = torch.randn(8, 32, 128, 128).cuda()
    center_pool = center_pool(32).cuda()
    out = center_pool(input)
    y = out.mean()
    y.backward()
